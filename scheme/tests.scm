...
(define lst (cons 1 (cons (cons 2 nil) (cons (cons 3 (cons 4 nil)) nil))))
(car (car (cdr (cdr lst))))
; expect 3
...
(begin (print 'a) (/ 1 0) (+ 2 3))
; expect a ; Error

((lambda (expr1 expr2 expr3) (and (or expr1 expr2) expr3)) (= 1 1) (> 0 5) #t)
; expect #t

((define (f x y) (print 'cat) (* x y)))
(f 10 2)
; expect cat ; 20
